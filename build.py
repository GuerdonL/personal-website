...
def main():
    ...
    parts = [
        ...
        '        <div id="metro-world">',
        '            <!-- Paper Plane Canvas (world-relative, behind everything) -->',
        '            <canvas id="planes-canvas" class="absolute top-0 left-0 pointer-events-none opacity-40" style="z-index:1;"></canvas>',
        '',
        build_hero(data),
        '',
        resume_html,
